...
func main() {
	...
	excludeEmails := false
	tldSort := false
	for i := 0; i < len(cmdLineArgs); i++ {
		switch strings.TrimSpace(cmdLineArgs[i]) {
		case "--tld-sort":
			tldSort = true
		case "--invalid-tlds":
			invalidTlds = true
	...
	// List of valid TLD as of 2021-08-17
	...
	// fmt.Println("Processing source code")
	...
	if tldSort {
		...
		sort.Slice(hostnames, func(i, j int) bool { return Reverse(hostnames[i]) < Reverse(hostnames[j]) })
